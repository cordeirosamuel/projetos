        ...
        public static void Correcao()
        {
            ...
            if (File.Exists(Arquivo.arquivoSeed))
            {
                ...
                using (StreamReader arquivo = File.OpenText(Arquivo.arquivoSeed))
                {
                    ...
                    //Inicio - lista com a cidade escrita errada
                    ...
                    //Fim - lista com a cidade escrita errada
                    ...
                    while ((linha = arquivo.ReadLine()) != null)
                    {
                        ...
                        // Corrige o nome da Siccob
                        string corrigeSicoob = "BANCO COOPERATIVO SICOOB S.A. - BANCO SI";

                        if ((codPortador == "0756") || (codPortador == "9756"))
                        {
                            linha = linha.Replace(headerPortador, corrigeSicoob);
                        }
                        ...
                        if (codComprovacao == "0K0")
                        {
                            linha = linha.Substring(0, 475) + "0K0" + linha.Substring(478);
                            tituloEspecial.Add("Comprovação do portador K " + nroProtocolo + "\n");
                        }

                        string especie = linha.Substring(214, 3);
                        if (especie == "DDI")
                        {
                            tituloEspecial.Add("Verificar espécie DDI: " + nroProtocolo + "\n");
                        }

                        //Quantidade de protocolos com e-mail/telefone do devedor informado
                        string controle = linha.Substring(0, 1);
